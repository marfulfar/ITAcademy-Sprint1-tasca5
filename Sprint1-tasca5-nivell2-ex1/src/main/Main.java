...
import customObjectSerializable.CustomObjectSerializable;
...
public class Main {
    public static void main(String[] args) throws IOException, ClassNotFoundException, ConfigurationException {
        ...
        creatingConfigFile(args[0],userSavingFile);
...
//Exercise 5 Serialization and deserialization of a custom object
    ...
    public static void creatingConfigFile(String userFolderPath, String userSavingFilePath) throws IOException {
        final File configFile = new File("config.properties");
        final FileWriter writer = new FileWriter(configFile);

        try {
            Properties props = new Properties();
            props.setProperty("userFolder",userFolderPath);
            props.setProperty("userSavingFile",userSavingFilePath);
            props.store(writer, "user folders");
